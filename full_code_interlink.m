...
731 
732 
sin gamma = A2/sqrt(A1�2+A2�2); 
733 
cos gamma = A1/sqrt(A1�2+A2�2); 
734 
sin psi = A4/sqrt(A3�2+A4�2); 

cos psi = A3/sqrt(A3�2+A4�2); 
...
psi*sin(f(sat1)))); 
742 
Rcomplex(step count, num pairs) = parameter(sat1)�2 * parameter(sat2)�2 * ( D1*cos(f(sat2))*(cos gamma*cos(f(sat1))+sin gamma*sin(f(sat1))) + ... 
743 
D2*sin(f(sat2))*(cos 
...
747 
Rv = sqrt((r(sat1)�2 * r(sat2)�2? 
r1dotr2complex�2)/(r(sat1)�2 + r(sat2)�2? 
2*r1dotr2complex))? 
body 
